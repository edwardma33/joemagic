...
function Navbar() {
  ...
  return (
    <main id='navbar' className='fixed w-full top-0'>
      <div className=' text-3xl bg-slate-200 p-4 w-full shadow-xl'>
        {showSidebar ? <MdOutlineClose onClick={toggleDropdown} className=' float-left cursor-pointer ' /> : <MdOutlineMenu onClick={toggleDropdown} className=' float-left cursor-pointer' />}
